$(() => {
    ...
    function getSizeIndex(sizes, id) {
        ...
        console.log("Index of selected size:", index); // Thêm dòng này để kiểm tra
        return index;
    }
    ...
    function addSize() {
        ...
        sizes.push(size); // Thêm kích thước mới vào mảng sizes
        renderSize(size); // Hiển thị kích thước mới
    }
    ...
    function renderSize(size) {
        ...
        console.log("Rendered size:", size); // Thêm dòng này để kiểm tra
    }
